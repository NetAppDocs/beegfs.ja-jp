...
NOTE: BeeGFS v8 にアップグレードする場合は、代わりにlink:clusters-upgrade-beegfs-v8.html["BeeGFS v8にアップグレード"]手順を参照してください。
...
| 7.4.6 | 8.0 | はい。 | link:clusters-upgrade-beegfs-v8.html["BeeGFS v8にアップグレード"]手順の指示に従ってアップグレードします。 


| 7.4.6 | 8.1 | はい。 | link:clusters-upgrade-beegfs-v8.html["BeeGFS v8にアップグレード"]手順の指示に従ってアップグレードします。 


| 7.4.6 | 8.2 | はい。 | link:clusters-upgrade-beegfs-v8.html["BeeGFS v8にアップグレード"]手順の指示に従ってアップグレードします。 
|===
