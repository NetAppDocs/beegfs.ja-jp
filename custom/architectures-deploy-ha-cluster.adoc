...
link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_cluster_building_blocks/beegfs_ha_playbook.yml["こちらをご覧ください"^]をクリックすると、完全なプレイブックファイルの例が表示されます。
